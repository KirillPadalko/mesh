...
// node_modules/@scure/bip39/node_modules/@noble/hashes/webcrypto.js
function _subtle() {
  const cr = typeof globalThis === "object" ? globalThis.crypto : null;
  const sb = cr == null ? void 0 : cr.subtle;
...
function mnemonicToSeedWebcrypto(mnemonic, passphrase = "") {
  return pbkdf22(sha5122, normalize2(mnemonic).nfkd, psalt(passphrase), { c: 2048, dkLen: 64 });
}
export {
  entropyToMnemonic,
  generateMnemonic,
